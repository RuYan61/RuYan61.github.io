// first-code.html typewriter 打字机 JS Begin
const texts = ["console.log('Hello, World!');", "windows.alert('Hello, World!');", "document.write('Hello, World!');"];    // 定义要循环显示的文本数组
...
type();    // 启动打字效果
// first-code.html typewriter 打字机 JS End
